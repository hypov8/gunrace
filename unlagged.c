...
// ACEBOT_ADD
		if (ent->acebot.is_bot) { //add hypov8 strafe delays bots aim
			float skill = (sv_botskill->value *.25) *125+75;
			time = (level.framenum - 2) * 100 + curtime - level.frameStartTime + (int)skill;
		}
		else
// ACEBOT_END
