...
qboolean Pickup_Pistol_Mods (edict_t *ent, edict_t *other) //G()^T pistol mod
{
//GUNRACE_START
#if 0
//GUNRACE_END
...
//GUNRACE_START
	...
	if (ent->count == 1)
    {
            if (other->client->pers.pistol_mods & WEAPON_MOD_ROF)
                    return false;
            other->client->pers.pistol_mods |= WEAPON_MOD_ROF;
            other->client->pers.hmg_shots = 30; //add hypov8. add -counter on all weps?
    }
    else if (ent->count == 2)
    {
	...
	if (ent->count <= 4)
	{
		if (other->client->pers.weapon == FindItem ("SPistol") 
			...
			||other->client->pers.weapon == FindItem ("Heavy machinegun")
			)
		{
			other->client->newweapon = other->client->pers.weapon;
			ChangeWeapon (other);
...
void Touch_Item (edict_t *ent, edict_t *other, cplane_t *plane, csurface_t *surf)
{
	...
	//GUNRACE_START
	if (!ent->item) //hypov8 causing crash with give xxx (weps)
...
//GUNRACE_START
	if (ent->dontDropToFloor){//if (ent->spawnflags & 4)
...
*/
	{
		"item_armor_helmet",							/*classname*/
		Pickup_Armor,									/* pickup */
		NULL,											/* use */
		NULL,											/* drop */
		NULL,											/* weaponthink */
		"world/pickups/generic.wav",					/* pickup_sound */
		"models/pu_icon/armor_head/armor_head.md2",		/* world_model */
		0,												/* world_model_flags */
		NULL,											/* view_model */

		/* client side info */
		"/pics/h_helmet_lt.tga",						/* icon */
		"Helmet Armor",									/* pickup_name */
		3,												/* count_width */	
		0,												/* quantity */
		NULL,											/* ammo */
		IT_ARMOR,										/* flags */
...
*/
	{
		...
		Use_Weapon2,
		Drop_Weapon,
		Weapon_Pistol_Duel, /*hypov8 todo*/
		"misc/w_pkup.wav",
		// note to Jason 
...
//GUNRACE_START
	{
		"weapon_machete", 							/*classname*/
		Pickup_Weapon,								/* pickup */
		Use_Weapon2,								/* use */
		Drop_Weapon,								/* drop */
		Weapon_Machete,								/* weaponthink */
		...
		NULL,										/* info */
		0,											/* tag */
		"weapons/melee/swing.wav"					/* precache */
	},
...
/* precache */ "weapons/shotgun/shotgf1b.wav weapons/shotgun/shotgr1b.wav"
	...
	//m41a
	{
		...
		NULL,
		0,
		"weapons/hyprbf1a.wav"/* precache */ //hypov8 MZ_HYPERBLASTER
	},

	// G()^T Uzi
	{
		"weapon_uzi", 						/*classname*/
		Pickup_Weapon,						/* pickup */
		Use_Weapon,							/* use */
		Drop_Weapon,						/* drop */
		...
		NULL,								/* info */
		0,									/* tag */
		"weapons/uzi/uzi_reload1.wav"		/* precache */ 
	},

	// G()^T M60
	{
		"weapon_M60", 							/*classname*/
		Pickup_Weapon,							/* pickup */
		Use_Weapon,								/* use */
		Drop_Weapon,							/* drop */
...
void SP_pistol_mod_rof (edict_t *self)
{
	//self->model = "models/pu_icon/ro_fire_mod/tris.md2";//GUNRACE_DISABLE
	self->model = "models/pu_icon/coolmod/box_mod.md2";//GUNRACE_ADD
	self->count = 1;
	SpawnItem (self, FindItem ("Pistol_Mods"));
