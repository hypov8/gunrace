...
// ACEBOT_ADD
#define MOD_BOT_SUICIDE			100 //added hypov8
// ACEBOT_END
...
//GUNRACE_START
extern	cvar_t	*weaponfrags; //add hypov8
extern	cvar_t	*weaponorder; //add goat
//GUNRACE_END
...
//GUNRACE_START
#define DEFAULT_SSHOTGUN_COUNT_GR	2
#define DEFAULT_M4BULLET_HSPREAD	100
#define DEFAULT_M4BULLET_VSPREAD	150
#define DEFAULT_M60_HSPREAD			950
#define DEFAULT_M60_VSPREAD			1050
#define DEFAULT_M60_HSPREAD_CROUCH	450
#define DEFAULT_M60_VSPREAD_CROUCH	550
//GUNRACE_END
...
//GUNRACE_END
	...
	int			accshot, acchit, fav[11], stole; //hypov8 was [8]
	//hypov8 todo FAV is no longer needed
	//hypov8 todo add new weps
	int			time;
...
//GUNRACE_START //get version
	int version; // gunrace client files version
	qboolean dontDropToFloor; //add hypov8 allow floating items(stdm5)
//GUNRACE_END
...
extern char default_weapon_order[16];//add goat random
...
//GUNRACE_START //get version
extern char ver_check[8]; //hypov8
//GUNRACE_END
